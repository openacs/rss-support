...
(note that subscr-ae doesn't accept <code>impl_name</code> as a URL
parameter for security reasons).</li><li>The scheduled proc <code>rss_gen_service</code> will create a
