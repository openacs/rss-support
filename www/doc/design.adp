...
<a href="mailto:dave\@thedesignexperience.org">Dave Bauer</a><p>From the <a href="http://groups.yahoo.com/group/rss-dev/files/specification.html">specification</a>,</p><blockquote><em>RDF Site Summary (RSS) is a lightweight
...
</ul><p><b>Service contract</b></p><p>The feed generation service contract is called
...
path to an RSS file is given by</p><blockquote><pre>
...
through web UI as well if that makes sense).</p><p>
...
subscription is allowed per summary context.</p><p>
...
parse this list-of-lists to generate a summary.</p><hr><address>
